...
switch rig
    ...
    case 2
        ...
        SS.eyeCalib.defaultGain      = [18.4325 -20.3254];  % default gain, used if no calibration points are entered
        SS.eyeCalib.defaultOffset    = [-0.9009 -1.8958];  % default offset, used if no calibration points are entered
...
SS.stim.GRATING.sFreq    = 1.5; % Spatial frequency, cycles/deg
...
SS.datapixx.TTL_spritzerDur       = 0.02; % duration of TTL pulse
SS.datapixx.TTL_spritzerNpulse    = 10;    % number of pulses in a series
SS.datapixx.TTL_spritzerPulseGap  = 0.2; % gap between subsequent pulses
